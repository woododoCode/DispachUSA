  ...
  return function (t) {
    ...
    ! function (o) {
      ...
      function b(t, e, n, r) {
        ...
        if (u < o.length) {
          if (1 === n) r = o[u] >= 5;
          else if (2 === n) r = o[u] > 5 || 5 == o[u] && (r || u < 0 || o[u + 1] !== g || 1 & o[u - 1]);
          else if (3 === n) r = r || !!o[0];
          else if (r = !1, 0 !== n) throw Error(v);
          if (u < 1) o.length = 1, r ? (t.e = -e, o[0] = 1) : o[0] = t.e = 0;
          else {
            if (o.length = u--, r)
              for (; ++o[u] > 9;) o[u] = 0, u-- || (++t.e, o.unshift(1));
      ...
      function y(t, e, n, r) {
        ...
        if (o = t.e, n = (u = t.c.join("")).length, 2 != e && (1 == e || 3 == e && r <= o || o <= i.NE || o >= i.PE)) u = u.charAt(0) + (n > 1 ? "." + u.slice(1) : "") + (o < 0 ? "e" : "e+") + o;
        else if (o < 0) {
          for (; ++o;) u = "0" + u;
          u = "0." + u
        } else if (o > 0)
      ...
      h.abs = function () {
        ...
        for (i = (f = r.length) < (c = o.length) ? f : c, u = -1; ++u < i;)
          if (r[u] != o[u]) return r[u] > o[u] ^ e ? 1 : -1;
        ...
        if (t === g) t = 0;
        else if (t !== ~~t || t < -c || t > c) throw Error(d);
        ...
        function e(n) {
          ...
          n instanceof e ? (r.s = n.s, r.e = n.e, r.c = n.c.slice()) : function (t, e) {
            var n, r, o;
            if (0 === e && 1 / e < 0) e = "-0";
            else if (!x.test(e += "")) throw Error(p + "number");
